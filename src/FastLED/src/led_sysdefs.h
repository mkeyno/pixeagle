...
#elif defined(STM32H7)  // Add this for STM32H743 (Pixeagle)
			#include "platforms/arm/stm32/led_sysdefs_arm_stm32.h"  // Reuse STM32F4 stubs (close enough for H7)

#elif defined(FASTLED_ARM) || defined(__ARM_ARCH_7EM__)
		#define FASTLED_ARM
		#define NOMCU  // No MCU-specific timing
